--- src/java/org/apache/cassandra/utils/FastByteOperations.java.orig	2018-02-20 21:20:39 UTC
+++ src/java/org/apache/cassandra/utils/FastByteOperations.java
@@ -179,6 +179,18 @@ public class FastByteOperations
...
@@ -197,7 +209,7 @@ public class FastByteOperations
             else
             {
                 obj1 = null;
...
+                offset1 = unsafeGetLong(buffer1, DIRECT_BUFFER_ADDRESS_OFFSET);
             ...
             int length1;
             {
@@ -219,7 +231,7 @@ public class FastByteOperations
             if (src.hasArray())
...
@@ -234,7 +246,7 @@ public class FastByteOperations
             else
             {
                 src = null;
...
@@ -244,7 +256,7 @@ public class FastByteOperations
             if (trgBuf.hasArray())
...
@@ -252,7 +264,7 @@ public class FastByteOperations
...
+                    trg[trgPosition + i] = unsafeGetByte(src, srcOffset + i);
             ...
             {
@@ -291,7 +303,7 @@ public class FastByteOperations
             else
             {
                 obj1 = null;
-                offset1 = theUnsafe.getLong(buffer1, DIRECT_BUFFER_ADDRESS_OFFSET);
...
@@ -314,7 +326,7 @@ public class FastByteOperations
             else
             {
                 obj2 = null;
...
+                offset2 = unsafeGetLong(buffer, DIRECT_BUFFER_ADDRESS_OFFSET);
             ...
             offset2 += position;
@@ -347,8 +359,8 @@ public class FastByteOperations
...
+                long rw = unsafeGetLong(buffer2, memoryOffset2 + i);
                 ...
                 if (lw != rw)
                 {
@@ -361,8 +373,8 @@ public class FastByteOperations
